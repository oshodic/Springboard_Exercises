...
const arrayOne = [{name: 'Elie'}, {name: 'Tim'}, {name: 'Matt'}, {name: 'Colt'}];
...
//console.log(extractValue(arrayOne,'name'));
// **** I had a tough time figuring this one out and had to use the solution for help. 
